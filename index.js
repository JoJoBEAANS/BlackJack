...
let bettingAmount = document.getElementById("bettingOptions").value
...
function bet(){
    bettingAmount = document.getElementById("bettingOptions").value
    if(pool < player.chips){
        if(bettingAmount == "5"){
            pool += 5
        } else if(bettingAmount == "10"){
            pool += 10
        } else if(bettingAmount == "100"){
            pool += 100
        }
    }
    poolEl.textContent = "Pool:" + pool
